...
public final class PowerHandler {
    ...
    public static class PerditionCalculator {
         ...
         * @return
         */
        public float applyPerdition(PowerHandler powerHandler, float current,
                long ticksPassed) {
     ...
     *            being common.
     */
    public void configure(float minEnergyReceived, float maxEnergyReceived,
            float activationEnergy, float maxStoredEnergy) {
    ...
    public void configurePowerPerdition(int powerLoss, int powerLossRegularity) {
        ...
        perdition = new PerditionCalculator((float) powerLoss
                / (float) powerLossRegularity);
    }
    ...
    private void applyPerdition() {
        if (perditionTracker.markTimeIfDelay(receptor.getWorld(), 1)
                && energyStored > 0) {
            ...
            if (newEnergy == 0 || newEnergy < energyStored)
                ...
                energyStored = DEFAULT_PERDITION.applyPerdition(this,
                        energyStored, perditionTracker.durationOfLastDelay());
            validateEnergy();
        }
    }
    ...
    public final class PowerReceiver {
         ...
         */
        public float receiveEnergy(Type source, final float quantity,
                ForgeDirection from) {
            float used = quantity;
