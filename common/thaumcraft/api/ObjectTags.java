...
public class ObjectTags implements Serializable
{
    ...
    public Map<EnumTag, Integer> tags = new HashMap<EnumTag, Integer>();// aspects
                                                                        // associated
                                                                        // with
                                                                        // this
                                                                        // object
    ...
    {
        ObjectTags temp = ThaumcraftApiHelper.getObjectTags(new ItemStack(id,
                1, meta));
    ...
    /**
     * Reduces the amount of an aspect in this collection by the given amount.
     * If reduced below 0 the aspect will be removed completely. If the aspect
     * does not exist then a negative value will be added. Only used by aura
     * internals for flux management.
     * 
     * @param key
     * @param amount
     * @return
    ...
    {
        if (tags.containsKey(aspect))
        {
            int oldamount = tags.get(aspect);
            amount += oldamount;
        }
        tags.put(aspect, amount);
        return this;
    }
