...
public class ResearchList
{
    ...
    /**
     * @param key
     * @return a list of the enumtags used in this research. returns the numeric
     *         values and not the actual enum
     */
    ...
    /**
     * @param key
     * @return the aspect enumtag ordinal with the highest value. Used to
