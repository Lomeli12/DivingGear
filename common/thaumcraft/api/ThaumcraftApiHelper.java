...
public class ThaumcraftApiHelper
{
    ...
    public static boolean isResearchComplete(String username, String researchkey)
    {
        ...
        try
        {
            ...
            {
                Class fake = Class
                        .forName("thaumcraft.common.research.ResearchManager");
                isResearchComplete = fake.getMethod("isResearchComplete",
                        String.class, String.class);
            }
            ot = (Boolean) isResearchComplete.invoke(null, username,
                    researchkey);
        } catch (Exception ex)
        {
    ...
    public static ItemStack getStackInRowAndColumn(Object instance, int row,
            int column)
    {
        ItemStack ot = null;
        try
        {
            Class fake = Class
                    .forName("thaumcraft.common.blocks.TileMagicWorkbench");
            Method getStackInRowAndColumn = fake.getMethod(
                    "getStackInRowAndColumn", int.class, int.class);
            ot = (ItemStack) getStackInRowAndColumn.invoke(instance, row,
                    column);
        } catch (Exception ex)
        {
    ...
    public static ObjectTags getObjectTags(ItemStack is)
    {
        ...
        try
        {
            ...
            {
                Class fake = Class
                        .forName("thaumcraft.common.ThaumcraftCraftingManager");
                getObjectTags = fake
    ...
    public static ObjectTags getBonusObjectTags(ItemStack is, ObjectTags ot)
    {
        ...
        try
        {
            if (getBonusTags == null)
            {
                Class fake = Class
                        .forName("thaumcraft.common.ThaumcraftCraftingManager");
                getBonusTags = fake.getMethod("getBonusTags", ItemStack.class,
                        ObjectTags.class);
            }
    ...
    public static ObjectTags generateTags(int id, int meta)
    {
        try
        {
            if (generateTags == null)
            {
                Class fake = Class
                        .forName("thaumcraft.common.ThaumcraftCraftingManager");
                generateTags = fake.getMethod("generateTags", int.class,
                        int.class);
            }
