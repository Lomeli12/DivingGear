...
public class RegisterThaum {
	...
	public static void register()
	{
		...
		{
			"WTW","TGT","ATA", 'T',Item.ingotIron, 'G',Block.glass, 'W',Item.bucketWater, 'A',Item.lightStoneDust//'T',ItemApi.getItem("itemThaumium", 1), 'G',Block.glass, 'W',ItemApi.getItem("itemShard", 1), 'A',ItemApi.getItem("itemShard", 1)
		});
	}
