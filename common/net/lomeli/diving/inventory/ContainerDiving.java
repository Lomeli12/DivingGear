...
public class ContainerDiving extends Container {
    ...
    public ContainerDiving(ItemStack stack, InventoryDiving inventory,
        ...
        if (stack.getItem() instanceof IGear) {
            ...
            if (type <= 0)
                this.addSlotToContainer(new SlotTank(this.helmInventory, 0, 79,
                        53));
            else if (type == 1) {
                this.addSlotToContainer(new SlotTank(this.helmInventory, 0, 79,
                        53));
                this.addSlotToContainer(new SlotTank(this.helmInventory, 1, 56,
                        46));
                this.addSlotToContainer(new SlotTank(this.helmInventory, 2,
                        102, 46));
            } else if (type == 2) {
                this.addSlotToContainer(new SlotDualTank(this.helmInventory, 0,
                        79, 53));
                this.addSlotToContainer(new SlotDualTank(this.helmInventory, 1,
                        56, 46));
                this.addSlotToContainer(new SlotDualTank(this.helmInventory, 2,
                        102, 46));
            }
        }
        ...
        for (int l = 0; l < 3; ++l) {
            for (int i1 = 0; i1 < 9; ++i1) {
                this.addSlotToContainer(new Slot(playerInv, i1 + l * 9 + 9,
                        8 + i1 * 18, 84 + l * 18));
            }
        }
    ...
    public ItemStack slotClick(int slotID, int buttonPressed, int flag,
        ...
        if (tmpSlot != null
                && tmpSlot.isSlotInInventory(player.inventory,
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 < 9) {
                if (!this.mergeItemStack(itemstack1, 9,
