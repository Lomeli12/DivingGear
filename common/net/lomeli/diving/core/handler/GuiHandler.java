...
public class GuiHandler implements IGuiHandler{
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world,
		...
		if(ID == 1){
			InventoryDiving inventory = new InventoryDiving(player.inventory.getCurrentItem(), 
				player, 1);
			return new ContainerDiving(player.inventory.getCurrentItem(), inventory, player.inventory);
		}
		else if(ID == 2 || ID == 3){
			InventoryDiving inventory = new InventoryDiving(player.inventory.getCurrentItem(), 
					player, 3);
			...
			return new ContainerAirCompressor(player.inventory, (TileEntityAirCompressor)tile);
		}
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world,
		...
		if(ID == 1){
			...
			return new GuiAirCompressor((TileEntityAirCompressor)tile, player.inventory);
		}
		return null;
	}
