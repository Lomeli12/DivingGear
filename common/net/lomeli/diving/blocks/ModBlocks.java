...
{
	public static String[] coralColors = { "Red", "Blue", "Orange", "Green", "Pink"};
	
	//Coral
	public static Block coral; 
	public static ItemStack redCoral, blueCoral, orangeCoral, greenCoral, pinkCoral;
	...
	public static void loadBlocks()
	{
		...
		for(int i = 0; i < 5; i++)
		{
			LanguageRegistry.addName(new ItemStack(coral, 1, i), coralColors[i] + " Coral");
		}
