...
public class BlockWaterMill extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if (player.isSneaking())
            ...
            if (!world.isRemote) {
                TileEntityWaterMill tile = (TileEntityWaterMill) world
    ...
    public void registerIcons(IconRegister iconRegister) {
        ...
        iconArray[0] = iconRegister.registerIcon(ModStrings.MOD_ID
                .toLowerCase() + ":watermill/top");
        iconArray[1] = iconRegister.registerIcon(ModStrings.MOD_ID
                .toLowerCase() + ":watermill/sideoff");
        iconArray[2] = iconRegister.registerIcon(ModStrings.MOD_ID
                .toLowerCase() + ":watermill/sideon");
    }
