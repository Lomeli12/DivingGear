...
public class ModStrings {
    ...
    public static final String VERSION = ModInts.MAJOR + "." + ModInts.MINOR
            + "." + ModInts.REVISION;
    ...
    public static String TICK_DESC = "Determines the number of ticks before the water mill produces power. Default - 100";
}
