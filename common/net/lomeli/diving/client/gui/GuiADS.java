...
public class GuiADS extends GuiContainer{

	public InventoryDiving adsInventory;
	public GuiADS(InventoryDiving inventory, InventoryPlayer playerInv) {
		super(new ContainerDiving(playerInv.getCurrentItem(), inventory, playerInv));
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		if(this.adsInventory.getStackInSlot(0) != null){
			int l = (this.adsInventory.getStackInSlot(0).getMaxDamage() - this.adsInventory.getStackInSlot(0).getItemDamage());
